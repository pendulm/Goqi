...
class FriendshipsControllerTest < ActionController::TestCase
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post :create, friendship: { from: @friendship.from, remark_name: @friendship.remark_name, status: @friendship.status, to: @friendship.to }
    end
  ...
  test "should update friendship" do
    put :update, id: @friendship, friendship: { from: @friendship.from, remark_name: @friendship.remark_name, status: @friendship.status, to: @friendship.to }
    assert_redirected_to friendship_path(assigns(:friendship))
  end
